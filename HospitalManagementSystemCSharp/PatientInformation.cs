    ...
    public partial class PatientInformation : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "")
            {
                try
                {
                    string getCust = "select name,gen,age,date,cont,addr,disease,status,r_type,building,r_no,price,eid from patient where id=" + Convert.ToInt32(textBox1.Text) + " ;";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = " Update patient set name='" + textBox2.Text + "',gen='" + gen + "',age='" + textBox3.Text + "',date='" + textBox4.Text + "',cont='" + textBox5.Text + "',addr='" + textBox6.Text + "',disease='" + textBox7.Text + "',status='" + textBox8.Text  + "',r_type='" + textBox10.Text + "',building='" + textBox9.Text + "',r_no='" + textBox11.Text + "',price='" + textBox12.Text + "',eid = '" + textBox13.Text + "' where id='" + textBox1.Text + "'";
